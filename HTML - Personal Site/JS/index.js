...
cramersrule.onclick = function () {
  document.location ='HTML - Personal Site\5 Cramers Rule.html';
}
...
//contents links
whatisamatrix2.onclick = function () {
  document.location ='1 Introduction to matrices.html';
}

addsubtractmatrices2.onclick = function () {
  document.location ='2 Adding and Subtracting Matrices.html';
}

multiplymatrices2.onclick = function () {
  document.location ='3 Multiplying Matrices.html';
}

determinant2.onclick = function () {
  document.location ='4 The Determinant and Inverse.html';
}

cramersrule2.onclick = function () {
  document.location ='HTML - Personal Site\5 Cramers Rule.html';
}

engineering2.onclick = function () {
  document.location ='6 Applying Matrices to Engineering.html';
}

calculator2x22.onclick = function () {
  document.location ='7 2x2 Calculator.html';
}

calculator3x32.onclick = function () {
  document.location ='10 3x3 Calculator.html';
}
...
circuitCalculator2.onclick = function(){
  document.location = '9 Circuit Calculator.html';
}

//end of contents links
contactCreator.onclick = function(){
  document.location = 'Contact details.html';
}
