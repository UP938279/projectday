pagelink1.onclick = function () {
  document.location ='#theDeterminantExplaination';
}
pagelink2.onclick = function () {
  document.location ='#determinant2x2Method';
}
pagelink3.onclick = function () {
  document.location ='#determinant3x3Method';
}
pagelink4.onclick = function () {
  document.location ='#theInverseExplaination';
}
pagelink5.onclick = function () {
  document.location ='#inverse2x2Method';
}
pagelink6.onclick = function () {
  document.location ='#inverse3x3Method';
}
